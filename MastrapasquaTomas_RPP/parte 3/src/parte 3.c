		 ...
		 do{
			 getValidInt(&option, "-----------------------------------------------------------------------------------\n"
					                 ...
					                 "8. Listado de perros con sus estadias reservadas\n "
					 	 	 	 	 "9. Alta perro\n"
					 	 	 	 	 "10. Cantidad de duenios que se llaman Alan y tienen una estadia reservada\n"
					 	 	 	 	 "11. Listado de estadias realizadas por duenios que se llaman Lucia y cuya fecha es durante la segunda quincena de noviembre 2021\n"
		 							 "12.SALIR\n"
		 							 "----------------------------------------------------------------------------------\n",
		 							 "Ingrese una opcion: \n"
		 							 "-----------------------------------------------------------------------------------\n"
		 		...
		 		case 9:
		 			...
		 			idPerro++;
		 			 perro_pedir(perro,  lenPerro,  idPerro);
		 		...
		 		case 10:
					...
					if(flag == 1)
					{
						...
						buscarDuenioAlan(duenio,  estadia,  perro,  len,  lenDuenio,  lenPerro);
		 		...
		 		case 11:
		 			...
		 			if(flag == 1)
		 			{
		 			 ...
		 			 buscarDueniaLucia(duenio,  estadia,  perro,   len,  lenDuenio,  lenPerro);
		 			}else
		 			{
